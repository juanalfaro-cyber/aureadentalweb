  ...
  const getInlineStyles = () => {
    return {
      ...
      backgroundImage: `radial-gradient(
        ...
        calc(var(--x, 0) * 1px)
        calc(var(--y, 0) * 1px),
        hsl(var(--hue, 210) 90% 75% / 0.1), transparent
      )`,
      ...
      position: 'relative',
      touchAction: 'none',
      border: '1px solid rgba(201, 166, 70, 0.15)', // base border logic
    };
  };
  ...
  const beforeAfterStyles = `
    ...
    [data-glow]::before {
      background-image: radial-gradient(
        ...
        calc(var(--x, 0) * 1px)
        calc(var(--y, 0) * 1px),
        hsl(var(--hue, 210) 100% 65% / 0.8), transparent 100%
      );
      filter: brightness(2);
    }
    ...
    [data-glow]::after {
      background-image: radial-gradient(
        ...
        calc(var(--x, 0) * 1px)
        calc(var(--y, 0) * 1px),
        hsl(var(--hue, 210) 100% 85% / 1), transparent 100%
      );
    }
